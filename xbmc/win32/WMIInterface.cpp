...
std::vector<std::string> CWIN32Wmi::GetWMIStrVector(std::string& strQuery, std::stringW& strProperty)
{
...
std::string CWIN32Wmi::GetWMIString(std::string& strQuery, std::stringW& strProperty)
{
